...
// No blocks for the free version
if (!SmartPodcastPlayerAdmin.licensed)
	return;
	
const sppIcon = wp.element.createElement('svg', {},
	wp.element.createElement('path', { fill: "rgb(33,172,105)", stroke: "none",
	d: "M14.6,0.2C6.5,0.2,0,6.7,0,14.8c0,8,6.5,14.6,14.6,14.6s14.6-6.5,14.6-14.6C29.2,6.7,22.6,0.2,14.6,0.2zM11.8,20v-9.8l8.5,4.9L11.8,20z",}),
	);

const stpIcon = wp.element.createElement('svg', {},
	wp.element.createElement('path', { fill: "rgb(33,172,105)", stroke: "none",
	d: "M21.9,2.8H0V0.1h21.9V2.8z",}),
	wp.element.createElement('path', { fill: "rgb(33,172,105)", stroke: "none",
	d: "M21.9,9.5H0V6.8h21.9V9.5z",}),
	wp.element.createElement('path', { fill: "rgb(33,172,105)", stroke: "none",
	d: "M13.3,16.2H0v-2.7h13.3V16.2z",}),
	wp.element.createElement('path', { fill: "rgb(33,172,105)", stroke: "none",
	d: "M6.6,22.9H0v-2.7h6.6V22.9z",}),
	wp.element.createElement('path', { fill: "rgb(33,172,105)", stroke: "none",
	d: "M21.5,15c-3.4,0-6.2,2.8-6.2,6.2s2.8,6.2,6.2,6.2c3.4,0,6.2-2.8,6.2-6.2S25,15,21.5,15z M20.3,23.5v-4.2l3.6,2.1L20.3,23.5z",})
	);

wp.blocks.registerBlockType( 'smart-podcast-player/spp', {
    title: 'Fusebox Full Player',
	description: 'Build and edit the shortcode for the Fusebox Full Player.',
    icon: sppIcon,
    category: 'widgets',
	...
	edit: function(props) {
		...
		function editButtonClick() {
			require(["text!../templates/shortcode-builder-spp-template.html", 'blockUI'], function(sppBuilder) {
				var sc = wp.shortcode.next('fusebox_full_player', props.attributes.text);
				if (!sc) {
					props.setAttributes({text: '[fusebox_full_player]'});
					sc = wp.shortcode.next('fusebox_full_player', '[fusebox_full_player]')
				}
...
wp.blocks.registerBlockType( 'smart-podcast-player/stp', {
    title: 'Fusebox Track Player',
	description: 'Build and edit the shortcode for the Fusebox Track Player.',
    icon: stpIcon,
    category: 'widgets',
	...
	edit: function(props) {
		...
		function selectLatestOrNo(e) {
			var sc = wp.shortcode.next('fusebox_track_player', props.attributes.text) ||
					 wp.shortcode.next('fusebox_track_player_latest', props.attributes.text);
		...
		function editButtonClick() {
			require(["text!../templates/shortcode-builder-stp-template.html", 'blockUI'], function(stpBuilder) {
				var sc = wp.shortcode.next('fusebox_track_player', props.attributes.text) ||
						 wp.shortcode.next('fusebox_track_player_latest', props.attributes.text);
				if (!sc) {
					props.attributes.text = '[fusebox_track_player]';
					sc = wp.shortcode.next('fusebox_track_player', '[fusebox_track_player]')
				}
				...
				var msg = _.template(stpBuilder)({
					isLatest: sc.shortcode.tag == "fusebox_track_player_latest",
